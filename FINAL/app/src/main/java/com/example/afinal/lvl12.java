...
public class lvl12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl12);
    ...
    public void onClickComprobar(View v) {
        if (rbText.isChecked()&& (editTxtTexto.getText().toString().equals("N")|| editTxtTexto.getText().toString().equals("n"))) {

            Toast.makeText(this, "Nueve osi osi", Toast.LENGTH_LONG).show();
