...
public class lvl6 extends AppCompatActivity {
    ...
    public void onClickComprobar(View v) {
        if (rbText.isChecked()&& (editTxtTexto.getText().toString().equals("corazon")||editTxtTexto.getText().equals("Corazon")||editTxtTexto.getText().equals("corazón")||
                editTxtTexto.getText().equals("Corazón"))) {

                Toast.makeText(this, "El que ella no tenía", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(this, "No lo se amigo", Toast.LENGTH_SHORT).show();
        }
