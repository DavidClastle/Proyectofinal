...
public class lvl5 extends AppCompatActivity {
    ...
    public void onClickComprobar(View v) {
        if (rbText.isChecked()&& (editTxtTexto.getText().toString().equals("384400km"))) {

                Toast.makeText(this, "Tan separados como tu de tu crush", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(this, "¿sabías que km no significa kilos mortales?", Toast.LENGTH_SHORT).show();
        }
